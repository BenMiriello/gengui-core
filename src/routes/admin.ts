 ...
 */
router.patch('/admin/users/:id/limits', requireAdmin, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/admin/users/:id/limits', requireAdmin, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/admin/queue/status', requireAdmin, async (_req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/admin/workers/status', requireAdmin, async (_req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 * NOTE: Placeholder until worker control API is implemented (#198)
 */
router.post('/admin/workers/start', requireAdmin, async (_req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 * NOTE: Placeholder until worker control API is implemented (#198)
 */
router.post('/admin/workers/stop', requireAdmin, async (_req: Request, res: Response, next: NextFunction) => {
  try {
